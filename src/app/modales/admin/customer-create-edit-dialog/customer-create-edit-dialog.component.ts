  ...
  implements OnInit
{
  ...
  get isDysonControl(): FormControl<boolean> {
    return this.customerForm.get(
      CustomerFormField.DYSON,
  ...
  private buildBody(): CustomerCreate | CustomerUpdate {
    return {
      ...
      dyson: this.customerForm.get(CustomerFormField.DYSON)?.value,
      markup:
        this.customerForm.get(CustomerFormField.MARK_UP)?.value ?? undefined,
      paymentTerms:
        this.customerForm.get(CustomerFormField.PAYMENT_TERMS)?.value ??
        undefined,
